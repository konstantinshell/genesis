...
async def receive_research_history(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        f"🔗 *Ссылка на профиль:*\n`{profile_url}`\n\n"
        f"⏰ *Профиль активируется в течение 1-2 часов*\n"
        f"По ссылке ты найдёшь:\n"
        f"  • 📊 Твой прогресс в исследовании\n"
        f"  • 🧠 7 сессий для участия\n"
        f"  • 📈 Статистику и результаты\n"
        f"  • 💡 Информацию о исследовании\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"Как это работает:\n"
